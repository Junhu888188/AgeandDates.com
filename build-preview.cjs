...
// Run from any directory, including a downloaded project on Windows or macOS.
const out=process.argv[2]?path.resolve(process.argv[2]):path.join(__dirname,'..','ageanddates-desktop-preview.html');
